...
class MEESoapFaultEx extends org.ksoap2.SoapFault
{
    public Object fault;
}
...
public class MEEExtendedSoapSerializationEnvelope extends com.easywsdl.exksoap2.serialization.ExSoapSerializationEnvelope {
    ...
    public static void setDateTimeConverter(MEEDateTimeConverter converter)
    {
        if(converter==null)
        {
            dateTimeConverter = new MEEStandardDateTimeConverter();
        }
        dateTimeConverter=converter;
    }

    public static MEEDateTimeConverter getDateTimeConverter()
    {
        return dateTimeConverter;
    }

    private static MEEDateTimeConverter dateTimeConverter = new MEEStandardDateTimeConverter();

    public MEEExtendedSoapSerializationEnvelope() {
        this(SoapEnvelope.VER11);
    }

    public MEEExtendedSoapSerializationEnvelope(int soapVersion) {
        super(soapVersion);
        implicitTypes = true;
        setAddAdornments(false);
        new MEEMarshalGuid().register(this);
    ...
    protected void writeProperty(XmlSerializer writer, java.lang.Object obj, PropertyInfo type) throws IOException {
        ...
        if (!type.multiRef && qName[2] == null )
        {
            if (!implicitTypes || (obj.getClass() != type.type && !(obj instanceof Vector ) && type.type!=java.lang.String.class  )) {
                java.lang.String xmlName=MEEHelper.getKeyByValue(classNames,obj.getClass());
                if(xmlName!=null) {
    ...
    private Object createObject(Object soap, Class cl) throws InstantiationException, IllegalAccessException, NoSuchMethodException, InvocationTargetException {
        ...
        Method ctor = obj.getClass().getMethod("loadFromSoap",Object.class,MEEExtendedSoapSerializationEnvelope.class);
    ...
    public static java.lang.Object getXSDType(java.lang.Object param)
    {
        ...
        java.lang.String xmlName=MEEHelper.getKeyByValue(classNames,obj);
        if(xmlName==null)
        {
            return obj;
        }
