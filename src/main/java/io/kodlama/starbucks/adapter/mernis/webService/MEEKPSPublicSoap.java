...
public class MEEKPSPublicSoap
{
    ...
    public MEEKPSPublicSoap(){}

    public MEEKPSPublicSoap(String url)
    {
        this.url = url;
    }

    public MEEKPSPublicSoap(String url,int timeOut)
    {
        this.url = url;
    ...
    {
        MEEExtendedSoapSerializationEnvelope envelope= new MEEExtendedSoapSerializationEnvelope(MEEExtendedSoapSerializationEnvelope.VER11);
